...
re <- Recommender(affinity.matrix[1:3], method = "IBCF")
r <- predict(re, affinity.matrix[4], n=5,type="ratings")
...
# scheme <- evaluationScheme(affinity.matrix, method = "split", trai   n = .9,k = 1, given = 1, goodRating = 4)
# 
# 
# algorithms <- list(
